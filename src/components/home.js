    ...
    <div>
        ...
        <div className="text-opacity">We promote academic excellence among preschoolers and prepare them for elementary school.</div>                
         <button className="wbutton hands-together-button">
            <div onClick={() => (window.location = "/donation")} className="vocab">Donate</div>
        </button>
        <h5 className="banner" style={{opacity: 1}}><b>Banner to advertise upcoming features</b></h5>
        </div>
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters" align="center">
                    ...
                    <div class="col-12 col-md-6" align="left" style={{paddingLeft: 80}}>
                        ...
                        <button onClick={() => (window.location = "/about")} className="ybutton hands-together-button">
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters" align="center">
                    ...
                    <div class="col-12 col-md-6" style={{paddingTop: 30}}>
                        ...
                        <button onClick={() => (window.location = "/programs")} style={{marginRight: 350, marginTop: 80}} className="smbutton hands-together-button">
            ...
            <div class="container-fluid p-0">
                ...
                <div class="row no-gutters" >
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <button onClick={() => (window.location = "/shop")} className="nbutton hands-together-button">
                            <h2>Shop now!</h2>
                        </button>
                    </div>
