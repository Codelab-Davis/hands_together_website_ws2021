...
function Home() {
    ...
    <div>
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-10" align="center">
                    <h5 className="banner-text"><b>Banner to advertise upcoming features</b></h5>
                </div>
                <div class="col-1"/>
            </div>
        </div>
        ...
        <div className="text-opacity">
            <h1>We promote academic excellence among preschoolers <br/>and prepare them for elementary school.</h1>
        </div>  
