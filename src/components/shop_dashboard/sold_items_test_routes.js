...
function SoldItemsTestRoutes() { 
    ...
    function addItem() { 
        axios.post('https://db.handstogether-sa.org/sold_items/add_item', test_item, { withCredentials: true })
          .then(res => {
            console.log(res);
        })
    } 
    ...
    function editItem() { 
        ...
        axios.put('https://db.handstogether-sa.org/sold_items/update_item', new_test_item, { withCredentials: true })
        .then(res => {
          console.log(res);
      })
    } 
    ...
    function getSale() { 
        axios.get('https://db.handstogether-sa.org/sold_items/get_sale/607bc1788e294828789c4923', { withCredentials: true })
        .then( res => {
          console.log(res)
        }) 
    }
    ...
    function getSoldItems() { 
        axios.get('https://db.handstogether-sa.org/sold_items/get_sold_items', { withCredentials: true }) 
            .then(res => { 
                console.log(res); 
            }) 
    }
