...
function Donation() {
  ...
  return(
    <div className="container-fluid p-0" id="donation-wrapper">
      <div className="row no-gutters">
        ...
        <div className="donation-container">
          <div className="row no-gutters donation-row">
            <div className="donation-small" onClick={() => checkout(10)}>
          ...
          <div className="row no-gutters donation-row">
            <div className="donation-large" onClick={() => checkout(250)}>
            ...
            <div className="donation-large" onClick={() => checkout(500)}>
