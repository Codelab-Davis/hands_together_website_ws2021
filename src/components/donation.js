        ...
        <div className="donation-container">
          <div className="row no-gutters donation-row">
            <div className="col-sm-12 col-md-4">
              <div className="donation-padding">
                <div className="donation-box" onClick={() => checkout(10)}>
            ...
            <div className="col-sm-12 col-md-4">
              <div className="donation-padding">
                <div className="donation-box" onClick={() => checkout(50)}>
            ...
            <div className="col-sm-12 col-md-4">
              <div className="donation-padding">
                <div className="donation-box" onClick={() => checkout(100)}>
          ...
          <div className="row no-gutters donation-row">
            <div className="col-sm-12 col-md-6">
              <div className="donation-padding">
                <div className="donation-box" onClick={() => checkout(250)}>
            ...
            <div className="col-sm-12 col-md-6">
              <div className="donation-padding">
                <div className="donation-box" onClick={() => checkout(500)}>
